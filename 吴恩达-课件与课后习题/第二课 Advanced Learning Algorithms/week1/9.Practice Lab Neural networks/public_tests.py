...
def test_c1(target):
    ...
    # Keras 3 compatible
    assert list(target.inputs[0].shape) == [None, 400], \
        f"Wrong input shape. Expected [None, 400] but got {list(target.inputs[0].shape)}"
